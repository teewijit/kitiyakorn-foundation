...
export function Footer() {
  ...
  return (
    <footer className="border-t border-border bg-footer pt-10">
      <div className="container-1200 grid grid-cols-[repeat(3,minmax(0,1fr))_1.5fr] gap-6 pb-[30px] max-lg:grid-cols-2 max-md:grid-cols-1 max-md:text-center">
