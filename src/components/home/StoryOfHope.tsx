  ...
  return (
    <section className="container-1200 py-[60px] max-lg:py-10">
      <SectionHeader
        ...
        subtitle="ทุกการผ่าตัดคือชีวิตใหม่ที่มูลนิธิร่วมส่งต่อให้ผู้ป่วยและครอบครัว"
      />
      ...
      <div className="grid grid-cols-[1.03fr_1fr] gap-6 max-lg:grid-cols-1">
        <div className="relative overflow-hidden rounded-2xl bg-card p-6 shadow-card">
          ...
          <p className="mt-3 text-[15px] leading-[1.85] text-foreground">
            <TextAccent>ทุกการผ่าตัด</TextAccent>{" "}
            คือโอกาสที่ผู้ป่วยจะได้กลับไปใช้ชีวิตกับครอบครัวอีกครั้ง
            และคือหลักฐานว่าการสนับสนุนเล็ก ๆ จากหลายคนสามารถเปลี่ยนชีวิตได้จริง
          </p>
          <p className="mt-4 font-heading text-sm font-semibold text-gold-dark">
            จากโครงการ: {featured.title}
          </p>
          <img
            src={featured.image}
            alt=""
          ...
          <div className="relative mt-5">
            <StoryDetailDialog item={featured}>
              <button
                type="button"
                className="motion-press inline-flex items-center gap-2 rounded-md border border-border bg-card-light px-4 py-2 font-heading text-[12.5px] font-medium text-gold-dark transition-smooth hover:border-gold hover:bg-gold-light"
              >
        ...
        <div className="flex flex-col gap-4">
          <div className="flex items-stretch gap-4 max-[600px]:flex-col">
            <ComparisonBox
              title="ก่อนการรักษา"
              text="ผู้ป่วยยากไร้จำนวนมากไม่สามารถรับผิดชอบค่าผ่าตัดหัวใจและทรวงอกได้ด้วยตนเอง"
            />
            ...
            <ComparisonBox
              title="หลังการรักษา"
              text="ผู้ป่วยได้รับโอกาสต่อชีวิต กลับมาใช้ชีวิตได้อย่างมีคุณภาพและยืนยาวขึ้น"
            />
          </div>
          <div className="rounded-xl border border-[#ebdcb5] bg-[#fcf6ec] p-5">
            <p className="flex items-start gap-2 text-[14px] leading-relaxed text-foreground">
              ...
              ทุกการสนับสนุนของท่านคือ
              <TextAccent>โอกาส</TextAccent>
              ที่มูลนิธิจะส่งต่อให้ผู้ป่วยได้มีชีวิตใหม่อีกครั้ง
            </p>
          </div>
        </div>
      </div>
...
function ComparisonBox({ title, text }: { title: string; text: string }) {
  return (
    <div className="min-h-[120px] flex-1 rounded-xl border border-border-light bg-card-light px-5 py-4">
      <p className="flex items-center gap-2 font-heading text-[15px] font-semibold text-gold-dark">
